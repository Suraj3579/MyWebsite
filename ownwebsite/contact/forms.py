...
class MsgForm(forms.Form):
    ...
    msg_text = forms.CharField(max_length=2000, help_text='Enter Message here', widget=forms.Textarea(attrs={"class":'form-control vis_field', "placeholder": 'Type Your Message Here', "row": '3'}))
